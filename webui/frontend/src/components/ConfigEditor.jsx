...
function ConfigEditor() {
  ...
  const isFieldDisabled = (key, groupName) => {
    ...
    if (key === "LogoFlatColor" || key === "PreserveMultiColorLogos") {
        const useLogo = getValue("UseLogo");
        const useBGLogo = getValue("UseBGLogo");
